...
Docums includes a couple [built-in themes] as well as various [third party
...
To use a theme that is included in Docums, simply add this to your
`docums.yml` config file.
...
!!! note
    ...
    your config. To do this, add the following to your docums.yml.

        extra_css: [extra.css]

After making these changes, they should be visible when you run
`docums serve` - if you already had this running, you should see that the CSS
...
For example, the [docums] theme ([browse source]), contains the following
...
And then point your `documsdocums.yml` configuration file at the new directory:
...
example, to alter the title of the Docums theme, your replacement `main.html`
...
blocks are available to override. The Docums and ReadTheDocs themes provide the
following blocks:
...
won't include it in the pages generated by Docums. Therefore, a link needs to
...
[browse source]: https://github.com/khanhduy1407/docums/tree/master/docums/themes/docums
[built-in themes]: #built-in-themes
[Bootstrap]: https://getbootstrap.com/
[theme configuration options]: ./configuration.md#theme
[Read the Docs]: https://readthedocs.org/
[community wiki]: https://github.com/khanhduy1407/docums/wiki/Themes
