...
project directory named `docums.yml`.
...
```yaml
google_analytics: ['UA-215113700-1', 'khanhduy1407.github.io/docums']
```
...
as part of docums and guarantees compatibility with Lunr.js even on languages
