...
To install Docums, run the following command from the command line:
...
initial heading to `Lorum`, and save your changes. Your browser will
...
[`site_name`][site_name] setting to `Lorum` and save the file.
...
file to that directory. Docums will automatically detect and use that file as your
favicon icon.
...
That's looking good. You're ready to deploy the first pass of your `Lorum`
...
See the [User Guide] for more complete documentation of all of Docums' features.

To get help with Docums, please use the [GitHub discussions] or [GitHub issues].
...
[GitHub discussions]: https://github.com/khanhduy1407/docums/discussions
