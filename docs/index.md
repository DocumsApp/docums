    ...
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">
            ...
            Docums. Choose between the built in themes: <a
            href="user-guide/choosing-your-theme/#docums">docums</a> and <a
            href="user-guide/choosing-your-theme/#readthedocs">readthedocs</a>,
            select one of the third-party themes listed on the <a
            href="https://github.com/khanhduy1407/docums/wiki/Docums-Themes">Docums
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">
            Docums builds completely static HTML sites that you can host on
